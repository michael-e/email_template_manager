...
2. Use XPath to select the data from your XML, like so: "SALE! {/data/sale/entry/title} for only {/data/sale/entry/price}!", which will turn into: "SALE! Websites for only €10.000!
